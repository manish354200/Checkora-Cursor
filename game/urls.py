...
urlpatterns = [
    ...
    path("api/puzzles/<int:puzzle_id>/", views.puzzle_detail_api, name="puzzle_detail_api"),
    path("api/puzzles/<int:puzzle_id>/solution/", views.puzzle_solution_api, name="puzzle_solution_api"),
